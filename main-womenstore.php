  ...
  <!-- include navigation-top -->
	...
	<div class="row">
		<ul class="small-block-grid-2 medium-block-grid-4 large-block-grid-4">
			<li align ="left"> <h4><b>WOMEN STYLE </b></h4></li>	
			<li></li>
			<li></li> 
			<li align ="right">
				<?php
				echo '<select name="Category" onChange="getSubCategory(this.value)">';
				$CategoryQuery = $mysqli->query("SELECT CategoryID, SubCategory FROM Categorys Where Category = 'WOMEN' OR CategoryID = 0");
		...
		<div class="WomenStore">
			<div class="MainStore-page">
				...
				If ($CategoryID == NULL) {	
					...
					Where T1.NOGOLLASCATEGORY='ITEM FOR SALE' And T1.ItemStatus = 1 AND T1.ItemSeller <> '$session' AND T2.Category = 'WOMEN' ORDER BY ItemID DESC");	
				}
				Else {
	...
	<script type="text/javascript"> 			
		function getSubCategory($CategoryID){  
			$.ajax({		
					type: "POST",
					success: function(){
					window.location = "main-womenstore.php?CategoryID="+$CategoryID
					}
			}); 
		}
	</script>
