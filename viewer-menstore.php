		...
		<div class="MenStore">
			...
			<div class="viewstore-page">
				...
				<?php				
					...
					Where T1.NOGOLLASCATEGORY='ITEM FOR SALE' And T1.ItemStatus = 1 AND T2.Category = 'MEN' ORDER BY ItemID DESC");
					...
					if ($resultRows > 0) {
						...
						echo '<li class="Item" align="center">';
						echo '<img src="'.$filePath.$row["ItemImageFileName"].'" />';
						echo '<h6>'.$row["ItemName"].'</h6>';
						echo '<h6>'.$row["ItemSize"].'</h6>';
